...
const ThemeToggle = () => {
  ...
  useEffect(() => {
    ...
    navElements.forEach(element => {
      element.style.color = theme === 'light' ? '#121212' : '#FBF8EF'; 
  ...
  return (
    <button 
      ...
      style={{
        ...
        height: '40px',
        cursor: 'pointer',
        backgroundColor: theme === 'light' ? '#000' : '#70cbff',
    ...
    >
      <motion.div
        ...
        style={{
          ...
          width: '30px',
          height: '30px',
          backgroundColor: theme === 'light' ? '#70cbff' : '#021526',
          borderRadius: '50%',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
      ...
      >
        {theme === 'light' ? <MoonStar size={18} color="#021526" /> : <SunDim size={18} color="#70cbff" />}
      </motion.div>
    </button>
  );
};
